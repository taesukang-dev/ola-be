...
@SQLDelete(sql = "UPDATE team_member_wait_list SET DELETED_AT = NOW() where id = ?")
@Where(clause = "deleted_at is null")
@Entity
public class TeamMemberWaitList {
    ...
    public TeamMemberWaitList(TeamBuildingPost post, User user) {
        this.post = post;
        this.user = user;
    }

    public static TeamMemberWaitList of(TeamBuildingPost post, User user) {
        return new TeamMemberWaitList(post, user);
    }
